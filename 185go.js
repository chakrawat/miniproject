...
function showMapttt() {
    ...
    var taxiIcon = L.icon({
        ...
        iconUrl: 'https://img2.pic.in.th/pic/185-Photoroom.png-Photoroom.png',
        iconSize: [150, 100]
    })
        ...
        L.Routing.control({
            ...
            createMarker: function(i, waypoint, n) {
                ...
                var markerNames = [
                    'มศว',
                    'ฟอร์จูนทาวน์,8บาท',
                    'บุญถาวร รัชดาภิเษก (ขาออก),8บาท',
                    'ศาลอาญา,8บาท',
                    'BTS รัชโยธิน (ทางออก 3),8บาท',
            ...
            // createMarker: function(i, waypoint, n) {
                ...
                var iconUrl = 'https://img2.pic.in.th/pic/busred.png'; // เปลี่ยนเป็น URL ของรูปภาพ Marker ที่ต้องการใช้
                var icon = L.icon({
                    iconUrl: iconUrl,
